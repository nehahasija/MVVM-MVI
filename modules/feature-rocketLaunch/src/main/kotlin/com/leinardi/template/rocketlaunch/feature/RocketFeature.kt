...
import com.leinardi.template.navigation.destination.rocketLaunch.RocketLaunchDestination
import com.leinardi.template.rocketlaunch.ui.RocketLaunchScreen
import com.leinardi.template.rocketlaunch.ui.debug.RocketLaunchDebugSection

class RocketFeature : Feature() {
    override val id = "ROCKET"

    override val composableDestinations: Map<NavigationDestination, @Composable () -> Unit> = mapOf(
        RocketLaunchDestination to { RocketLaunchScreen() }
    )
